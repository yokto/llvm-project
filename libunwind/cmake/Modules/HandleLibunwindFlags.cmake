...
macro(add_cxx_compile_flags_if_supported)
  foreach(flag ${ARGN})
      mangle_name("${flag}" flagname)
      check_cxx_compiler_flag("${flag}" "CXX_SUPPORTS_${flagname}_FLAG")
      message("foo ${flag} CXX=${CMAKE_CXX_COMPILER} LIBUNWIND_SUPPORTS_${flagname}_FLAG=${LIBUNWIND_SUPPORTS_${flagname}_FLAG}")
      message("foo ${flag} CXX=${CMAKE_CXX_COMPILER} CXX_SUPPORTS_${flagname}_FLAG=${CXX_SUPPORTS_${flagname}_FLAG}")
